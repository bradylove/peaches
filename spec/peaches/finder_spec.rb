...
describe "Peaches::Finder" do
  ...
  it "should find a 2nd level file or directory with fuzzy name" do
    finder.find("pches", root).should == ["lib/peaches/finder.rb", "lib/peaches/version.rb", "lib/peaches.rb", "spec/peaches/finder_spec.rb", "spec/peaches_spec.rb"]
  end

  it "should find a file without having the first letter of the file" do
    finder.find("spec", root).should == [".rspec", "spec/peaches/finder_spec.rb", "spec/peaches_spec.rb", "spec/spec_helper.rb"]
  end
end
